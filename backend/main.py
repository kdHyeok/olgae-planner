...
<small>비밀번호는 얼개 플래너에서만 확인하며 ChatGPT나 Codex에 전달하지 않습니다.</small>
    ...
    return HTMLResponse(body, status_code=status, headers={
        ...
        "Content-Security-Policy": "default-src 'none'; style-src 'unsafe-inline'; form-action 'self' https://chatgpt.com https://accounts.google.com; base-uri 'none'; frame-ancestors 'none'",
